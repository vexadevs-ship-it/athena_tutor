...
export type ShapeStyle = {
  ...
  fillColor?: string;
  dashed?: boolean;
  themeIcon?: "basketball" | "flower" | "space" | "sword" | string;
};
...
export type WhiteboardAction =
  ...
  | ({ type: "draw_shape"; shape: "line" | "arrow" | "circle" | "rect" | "thematic_icon"; points: (Position | LocalPoint)[]; style?: ShapeStyle; width?: number; height?: number } & LayoutHint)
  ...
  | NumberLineAction
  | TableAction
  | { type: "illustration"; illustrationType: "basketball" | "flower" | "rocket" | "trophy" | "brain" | "zap"; position?: Position; style?: ShapeStyle; width?: number; height?: number } & LayoutHint
  | CheckInAction
  | PredictAction
  | FillBlankAction;
...
export type WhiteboardCanvasProps = {
  ...
  onCoordinatePlaneClick?: (action: CoordinatePlaneAction) => void;
  onComplete?: () => void;
